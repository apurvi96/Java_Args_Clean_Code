...
public class ArgsTest {
  ...
  public void testWithNoSchemaButWithOneArgument() throws Exception {
    try {
      ...
      fail("Args constructor should have thrown exception No Schema");
  ...
  public void testNonLetterSchema() throws Exception {
    try {
      new Args("*", new String[]{});
      fail("Args constructor should have thrown exception Wrong Schema Format");
    } catch (ArgsException e) {
  ...
  @Test
  public void testValidBooleanPresent() throws Exception {
    Args args = new Args("x", new String[]{"-x"});
    assertEquals(true, args.getBoolean('x'));
  }

  @Test
  public void testValidStringPresent() throws Exception {
 ...
 @Test
  public void testInvalidlabelFormedOfTwoValidArgs() throws Exception {
    try {
  ...
  @Test
  public void testValidIntPresent() throws Exception {
  ...
  public void testInvalidInteger() throws Exception {
    try {
      new Args("x#", new String[]{"-x", "Seven"});
      fail("Args constructor should have throws exception");
    } catch (ArgsException e) {
      assertEquals(INVALID_INTEGER, e.getErrorCode());
      assertEquals('x', e.getErrorArgumentId());
      assertEquals("Seven", e.getErrorParameter());
    }
  ...
  @Test
  public void testValidDoublePresent() throws Exception {
  ...
  @Test
  public void testOneStringArray() throws Exception {
  ...
  @Test
  public void mapValidArgument() throws Exception {
  ...
  @Test
  public void malFormedMapArgumentEmptyKey() throws Exception {
   try {
